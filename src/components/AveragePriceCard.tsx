        ...
        <div className="flex flex-col h-full">
          ...
          <div className="mt-auto">
            <ToggleGroup 
              ...
              <ToggleGroupItem 
                value="month" 
                className={`flex-1 text-xs py-1 rounded transition-all data-[state=on]:bg-white data-[state=on]:text-bitcoin data-[state=on]:font-regular ${selectedPeriod !== 'month' && 'text-gray-500 hover:bg-white/50'}`}
              >
                Mensal
              </ToggleGroupItem>
              <ToggleGroupItem 
                value="year" 
                className={`flex-1 text-xs py-1 rounded transition-all data-[state=on]:bg-white data-[state=on]:text-bitcoin data-[state=on]:font-semibold ${selectedPeriod !== 'year' && 'text-gray-500 hover:bg-white/50'}`}
              >
                Anual
              </ToggleGroupItem>
              <ToggleGroupItem 
                value="all" 
                className={`flex-1 text-xs py-1 rounded transition-all data-[state=on]:bg-white data-[state=on]:text-bitcoin data-[state=on]:font-semibold ${selectedPeriod !== 'all' && 'text-gray-500 hover:bg-white/50'}`}
              >
                Total
              </ToggleGroupItem>
            </ToggleGroup>
