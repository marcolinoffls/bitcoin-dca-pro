        ...
        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
          ...
          <PopoverContent className="w-auto p-0" align="start">
            <div className="p-3 rounded-md shadow-sm">
              ...
              />
              <div className="flex justify-center mt-0.8">
                <Button 
                  type="button" 
                  onClick={handleConfirm}
                  className="w-full rounded-lg bg-bitcoin hover:bg-bitcoin/90 text-white ml-[20px] mr-[20px]" // px é o espaçamento do botao
                >
